...
//			String yCoord = entries[2];
			Double xCoord = Double.parseDouble(entries[1]);
			Double yCoord = Double.parseDouble(entries[2]);
			availableAirportCoordinates.put(airportCode, new Coord(xCoord, yCoord));
		}
		brAirports.close();
