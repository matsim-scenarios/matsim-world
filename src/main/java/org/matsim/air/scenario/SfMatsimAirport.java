...
package org.matsim.air.scenario;
...
public class SfMatsimAirport {
	...
	private void createCoordsTwoRunways() {
		...
		coordApronStart = new Coord(this.coordApronEnd.getX(), this.coordApronEnd.getY() + taxiwayLength); 
		coordTaxiInboundStart = new Coord(this.coordApronEnd.getX() - taxiwayLength, 
				this.coordApronEnd.getY() - taxiwayLength); 
		coordTaxiOutboundEnd = new Coord(coordApronStart.getX() - taxiwayLength, 
				coordApronStart.getY()	+ taxiwayLength); 
		
		coordRunwayInboundStart = new Coord(coordTaxiInboundStart.getX() - runwayLength,
				coordTaxiInboundStart.getY()); 
		coordRunwayOutboundEnd = new Coord(coordTaxiOutboundEnd.getX() - runwayLength, coordTaxiOutboundEnd.getY()); 
	}

	private void createCoordsOneRunway() {
		coordApronEnd = this.coord;
		coordApronStart = new Coord(this.coordApronEnd.getX() + taxiwayLength, this.coordApronEnd.getY());
		coordTaxiOutboundEnd = new Coord(coordApronEnd.getX() + runwayLength/2, this.coordApronEnd.getY() - taxiwayLength);
		coordRunwayInboundStart = coordTaxiOutboundEnd;
		coordTaxiInboundStart = new Coord(this.coordApronEnd.getX() - runwayLength/2, this.coordApronEnd.getY() - taxiwayLength);
	...
	private void createStar(Network network) {
		...
		Coord coordStar = new Coord(coordRunwayInboundStart.getX() - starInfo.getLength(),
